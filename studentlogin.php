...
<script src="./bootstrap/js/bootstrap.min.js"></script>
 ...
 <center><h4 id="success" style="z-index: 5; margin-left: 5em; margin-top: 8em; "></h4></center>

<?php
$regno=test_input(@$_GET['r']);
...
$sql=mysqli_query($db, "SELECT * FROM studentreg WHERE regno='$regno' AND pswd='$password' LIMIT 1");
